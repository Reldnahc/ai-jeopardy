        ...
        <div className="min-h-screen bg-gradient-to-r from-indigo-400 to-blue-700 flex items-center justify-center p-6 ">
            ...
            <div className="bg-white rounded-xl shadow-2xl overflow-hidden w-full max-w-6xl p-20 pt-4">
                ...
                <div className="col-span-2 p-10">
                    ...
                    <p className="text-xl text-gray-700 text-center mt-4">Try to answer with the correct question.</p>
                    ...
                    <div className="mt-8">
                        <details className="bg-gray-50 p-6 rounded-lg border border-gray-200 shadow" open>
                            ...
                            <p className="mt-4 text-lg text-gray-700">
                                ...
                                classic TV show. The project is still evolving, so thank you for your patience as new
                                features are added and improved.
                            </p>
                            ...
                            <ul className="list-disc ml-6 mt-3 text-lg text-gray-700 space-y-2">
                                <li>You must create an account using the menu in the top-right corner to host or join a game.</li>
                                <li>Once in a lobby, players choose the categories they’d like questions generated from.</li>
                                <li>When everyone is ready, the host presses <strong>“Start Game”</strong> to begin.</li>
                            </ul>

                            <h3 className="mt-6 text-xl font-semibold text-gray-800">How Jeopardy Works</h3>
                            <ul className="list-disc ml-6 mt-3 text-lg text-gray-700 space-y-2">
                                <li>The board contains categories with increasing dollar values. Higher values are more difficult.</li>
                                ...
                                <li>Players race to buzz in. The first player to buzz gets the chance to answer.</li>
                                <li>If the answer is correct, that player earns the clue’s dollar value.</li>
                                <li>
                                    If the answer is incorrect, that player is <strong>locked out</strong> from buzzing on that clue again,
                                    and other players may buzz in.
                                </li>
                                <li>If no one answers correctly before time runs out, the answer is revealed and no points are awarded.</li>
                            </ul>

                            <h3 className="mt-6 text-xl font-semibold text-gray-800">Final Jeopardy</h3>
                            <ul className="list-disc ml-6 mt-3 text-lg text-gray-700 space-y-2">
                                <li>After all clues are played, the game moves to <strong>Final Jeopardy</strong>.</li>
                                ...
                                <li>Correct answers add the wagered amount to the player’s score. Incorrect answers subtract it.</li>

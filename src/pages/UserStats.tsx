  ...
  const statGroups = useMemo(() => {
    ...
    const gameplay: StatCard[] = [
      { label: "Games Played", value: fmtInt(p?.games_played), hint: "Total games joined." },
      {
        ...
        value: fmtInt(p?.games_finished),
        hint: "Games completed to the end.",
      },
      { label: "Games Won", value: fmtInt(p?.games_won), hint: "Games finished in 1st place." },
      {
        label: "Boards Generated",
        value: fmtInt(p?.boards_generated),
        hint: "Jeopardy boards created.",
      },
      { label: "Clues Selected", value: fmtInt(p?.clues_selected), hint: "Clues you chose." },
      {
        label: "Clues Skipped",
        value: fmtInt(p?.clues_skipped),
        hint: "Clues revealed without answering.",
      },
    ...
    const accuracy: StatCard[] = [
      {
        ...
        value: fmtInt(p?.correct_answers),
        hint: "Clues answered correctly.",
      },
      {
        label: "Wrong Answers",
        value: fmtInt(p?.wrong_answers),
        hint: "Clues answered incorrectly.",
      },
      {
        label: "Answer Accuracy",
        value: pct(p?.correct_answers, (p?.correct_answers ?? 0) + (p?.wrong_answers ?? 0)),
    ...
    const buzzing: StatCard[] = [
      {
        label: "Times Buzz Won",
        value: fmtInt(p?.times_buzzed),
        hint: "Times you buzzed in first.",
      },
    ...
    const dailyDouble: StatCard[] = [
      {
        ...
        value: fmtInt(p?.daily_double_found),
        hint: "Daily Doubles you uncovered.",
      },
      {
        label: "Daily Doubles Correct",
        value: fmtInt(p?.daily_double_correct),
        hint: "Daily Doubles answered correctly.",
      },
      {
        label: "True Daily Doubles",
        value: fmtInt(p?.true_daily_doubles),
        hint: "Max-wager Daily Doubles.",
      },
      {
    ...
    const finalJeopardy: StatCard[] = [
      {
        label: "FJ Participations",
        value: fmtInt(p?.final_jeopardy_participations),
        hint: "Final Jeopardy appearances.",
      },
      {
        label: "FJ Correct",
        value: fmtInt(p?.final_jeopardy_corrects),
        hint: "Final Jeopardy correct responses.",
      },
      {
        label: "FJ Accuracy",

...
export type UseGameSocketSyncResult = {
  ...
  ttsReady: TtsReady | null;
  answerCapture: AnswerCaptureStartMsg | null;
  answerTranscript: AnswerTranscriptMsg | null;
  answerResult: AnswerResultMsg | null;
  answerError: string | null;
  phase: string | null;
  selectorKey: string | null;
  selectorName: string | null;
  aiHostText: string | null;
  aiHostAsset: string | null;
  boardSelectionLocked: boolean | null;
  ddWagerCapture: DailyDoubleWagerCaptureStartMsg | null;
  ddWagerHeard: DailyDoubleWagerHeardMsg | null;
  ddWagerLocked: DailyDoubleWagerLockedMsg | null;

...
export const models: Model[] = [
  ...
  },
  {
    ...
    provider: "anthropic",
    strengths: ["Strong writing quality", "Good instruction following", "Broad reasoning depth"],
    bestFor: "High-quality board writing when you want an Anthropic alternative",
    availabilityNote: "Requires ANTHROPIC_API_KEY on the backend.",
    price: 100,
  },
  {
    ...
    provider: "anthropic",
    strengths: ["Fast turnaround", "Lower cost", "Useful baseline comparisons"],
    bestFor: "High-volume board benchmarking and speed-oriented generation",
    availabilityNote: "Requires ANTHROPIC_API_KEY on the backend.",
    price: 100,
  },
  {
    ...
    label: "DeepSeek Chat",
    provider: "deepseek",
    strengths: ["Low-cost generation", "Strong throughput", "Solid structured outputs"],
    bestFor: "Fast, inexpensive board generation and bulk benchmark runs",
    availabilityNote: "Requires DEEPSEEK_API_KEY on the backend.",
    price: 0,
  },
  {
    ...
    provider: "deepseek",
    strengths: ["Long-form reasoning", "Stepwise problem solving", "Higher-complexity prompts"],
    bestFor: "More deliberate clue writing and evaluation with a DeepSeek model",
    availabilityNote: "Requires DEEPSEEK_API_KEY on the backend.",
    price: 100,
  },
];
